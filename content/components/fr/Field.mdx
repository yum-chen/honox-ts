...
Ce composant est disponible en tant que bloc `field` dans le [Générateur de page](/docs/PageBuilder) (`content/pages/*.json`) :
...
| --- | --- | --- |
| `children` | `any` | Contenu à afficher dans le composant. If provided, the internal input is not rendered. |

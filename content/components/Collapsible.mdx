...
| `interactive`        | `boolean`                     | Enable client-side interactivity. Collapsible is **Interactive-First (auto-interactive)**: it always hydrates as an island unless you pass `interactive={false}`. |
...
Collapsible is classified as **Interactive-First (auto-interactive)**.

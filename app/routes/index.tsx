			...
			>
				<div class={css({ maxW: "4xl", mx: "auto", textAlign: "center" })}>
					<Badge
						...
						class={css({ mb: "4" })}
					>
						Production Ready Hono/JSX Components
					</Badge>
					<Heading
						as="h1"
						class={css({
			...
			>
				<div class={css({ textAlign: "center", mb: "8" })}>
					<Heading as="h2" size="3xl" class={css({ fontWeight: "bold" })}>
						Featured Carousel Port
					</Heading>
					<Text size="md" class={css({ color: "fg.muted", mt: "2" })}>
						Demonstrating our robust Hono/JSX port of Ark UI's Slider Carousel.
								...
								content: (
									<div class={css({ mt: "6" })}>
										<Grid columns={{ base: 1, md: 2, lg: 3 }} gap="6">
											...
											<Card
												title="Slider"
												description="Adjustable numeric values"
											>
												...
												<div class={css({ mt: "2" })}>
													<Collapsible
														...
														content={
															...
															>
																<Text size="sm">
																	Our accessible focus trap and keyboard
																	navigation works cleanly across all devices.
																</Text>
															</div>
														}
													/>

...
export function InteractiveDialog(props: InteractiveDialogProps) {
	...
	const handleOpenChange = (nextOpen: boolean) => {
		console.log(
			"[Dialog] handleOpenChange called with:",
			nextOpen,
			"isControlled:",
			isControlled,
		);
		if (!isControlled) {
			console.log("[Dialog] Calling setIsOpen(", nextOpen, ")");
			setIsOpen(nextOpen);
		}
	...
	useEffect(() => {
		...
		console.log(
			"[Dialog] All data-part attributes in root:",
		...
		console.log("[Dialog] Found positioners:", positioners.length);
		console.log("[Dialog] Found backdrops:", backdrops.length);
